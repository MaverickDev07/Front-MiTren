  ...
  return (
    <div className="w-full min-h-screen relative flex flex-col justify-start items-center">
      <div className="w-full lg:px-20 xl:px-[101px]">
        <NavigatorTop title='VENTA TARJETA NFC' LinkTo='/boleteria'/>
      </div>
      <div className="w-full lg:p-20 xl:px-[101px] flex flex-col items-center">
        <div className="flex flex-col items-center justify-center text-center">
            <h3 className="font-Inconsolata text-2xl sm:text-5xl text-white uppercase p-8">Transacción </h3>
            <h3 className="font-Inconsolata text-2xl sm:text-5xl text-white uppercase p-8">exitosa</h3>
...
export default VerificationPay;